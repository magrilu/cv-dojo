...
LLM can now produce a surprising amount of working code in very little time, and much of it is correct. They will explain it as well, and clearly. But an explanation received is not the same as an argument understood.
...
| 03  | Rectification            | [affine](notebooks/04-rectification/affine.ipynb), metric, stratified, direct |
...
This collection is maintained by [Luca Magri](https://magrilu.github.io/) at
Politecnico di Milano.


Corrections, questions, and suggestions are always welcome. You can reach me by
email.

Code is released under the MIT License. Text and figures are licensed under CC
BY-NC-ND 4.0; see the [licensing
